...
type Settings = { email: string; whatsappNumber: string; linkedinUrl: string; serviceArea: string; hours: string };
const empty: Settings = { email: "", whatsappNumber: "", linkedinUrl: "", serviceArea: "", hours: "" };

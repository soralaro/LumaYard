...
export default function Home() {
  ...
  return (
    <main className="overflow-x-clip bg-[var(--paper)] text-[var(--forest)]">
      ...
      <div className="bg-[var(--forest-deep)] px-6 pb-8 pt-1 text-[var(--cream)] sm:px-10 lg:px-14 xl:px-16"><div className="mx-auto flex max-w-[1800px] items-center justify-end border-t border-white/10 pt-6"><SocialLinks compact colored /></div></div>
    </main>
  );
}

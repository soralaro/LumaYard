  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="grid bg-[#183a31] text-white lg:grid-cols-2">
        ...
        <div className="relative min-h-[430px] overflow-hidden"><img src="https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?auto=format&fit=crop&w=1300&q=85" alt="A warm outdoor dining table at night" className="absolute inset-0 h-full w-full object-cover" /><div className="absolute inset-0 bg-[#15352d]/15" /><div className="absolute bottom-7 left-7 flex items-center gap-3 rounded-full bg-[#f5f2eb] px-4 py-2.5 text-xs font-semibold text-[#17362e]"><Icon name="spark" className="h-4 w-4 text-[#b96a48]" />Designed for the golden hour</div></div>
      </section>
      ...
      <section id="look" className="bg-[#f5f2eb] px-5 py-22 sm:px-8 md:py-30 lg:px-14">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="relative overflow-hidden bg-[#697961]"><img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=1800&q=88" alt="A layered outdoor backyard setup" className="aspect-[1.1] min-h-[440px] w-full object-cover md:aspect-[2.25]" /><div className="absolute inset-0 bg-gradient-to-r from-[#102c25]/68 via-transparent to-transparent" />
